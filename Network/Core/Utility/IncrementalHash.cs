...
namespace System.Security.Cryptography
{
    ...
    {
        private const int NteBadAlgid = unchecked((int)0x80090008);
        ...
        [Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Security", "CA5351", Justification = "MD5 is used when the user asks for it.")]
        [Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Security", "CA5350", Justification = "SHA1 is used when the user asks for it.")]
        private static HashAlgorithm GetHashAlgorithm(HashAlgorithmName hashAlgorithm)
        {
            ...
            throw new CryptographicException(NteBadAlgid);
        }
